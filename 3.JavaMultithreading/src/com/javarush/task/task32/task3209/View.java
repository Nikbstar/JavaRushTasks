...
public class View extends JFrame implements ActionListener {
    ...
    public void initEditor() {
        ...
        tabbedPane.addTab("HTML", htmlScroll);
        JScrollPane plainScroll = new JScrollPane(plainTextPane);
        tabbedPane.addTab("Текст", plainScroll);
    ...
    public void showAbout() {
        JOptionPane.showMessageDialog(this, "Информация о программе", "Info", JOptionPane.INFORMATION_MESSAGE);
    }
